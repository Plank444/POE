...
public class UserAccountTest {
    ...
    public void testLoginUser_Successful() {
        ...
        assertTrue(userAccount.loginUser("Kyle!!!!!!!", "Ch&&sec@ke99!"), "Username incorrectly formatted.");
    }

    @Test
    public void testLoginUser_InvalidUsername() {
        userAccount.registerUser("Lerato", "Password", "Lerato", "Plank");
        assertTrue(!userAccount.loginUser("Lerato", "Password44"), "Incorrect password.");
    }

    @Test
    public void testLoginUser_InvalidPassword() {
        userAccount.registerUser("Lea_1", "Password$$!", "Lea", "Plank");
        assertTrue(!userAccount.loginUser("Lea_1", "Password$$!"), "Incorrect password.");
    }
